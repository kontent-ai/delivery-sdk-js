...
> If you want to mock http responses, it is possible to use [custom Http Service](https://github.com/Kentico/kontent-core-js#testing) as a part of the [delivery client configuration](#client-configuration).
