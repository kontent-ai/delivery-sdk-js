import { Elements, IUrlSlugResolverResult, richTextResolver, ItemUrlSlugResolver } from '../../../../lib';
...
describe('Rich text linked items and components', () => {
    ...
    it(`Checks that linked items and components are properly mapped (parse5)`, () => {
        ...
        const resolvedData = element.resolveData();
    ...
    it(`Checks that linked items and components are properly mapped (browser)`, () => {
        const element = new Elements.RichTextElement(
            {
                rawElement: {
                    name: 'name',
