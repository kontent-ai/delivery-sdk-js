...
describe('Rich text with invalid item data type', () => {
    ...
    it(`Resolving HTML should not throw exception when unknown item data type is used (parse5)`, () => {
    ...
    it(`Resolving HTML should not throw exception when unknown item data type is used (browser)`, () => {
        const elementWithoutRichTextResolver = new Elements.RichTextElement(
            {
                rawElement: {
                    name: 'name',
