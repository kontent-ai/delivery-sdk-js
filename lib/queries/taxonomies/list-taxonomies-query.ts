...
import type { PagingDeliveryRequest } from "../../models/request.models.js";
...
export type ListTaxonomiesQueryRequest = PagingDeliveryRequest<keyof TaxonomyPayload<DeliveryClientSchema>["system"]>;
