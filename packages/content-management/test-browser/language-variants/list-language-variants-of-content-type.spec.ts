...
describe('List language variants of content type', () => {
    ...
    it(`url should be correct`, () => {
        ...
        expect(codenameUrl).toEqual(`https://manage.kenticocloud.com/v2/projects/${testProjectId}/types/codename/xCodename/variants`);
        expect(externalIdUrl).toEqual(`https://manage.kenticocloud.com/v2/projects/${testProjectId}/types/external-id/xExternalId/variants`);
    });
