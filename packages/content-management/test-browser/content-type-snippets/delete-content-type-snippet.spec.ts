...
describe('Delete content type snippet', () => {
    ...
    it(`url should be correct`, () => {
        ...
        expect(codenameUrl).toEqual(`https://manage.kenticocloud.com/v2/projects/${testProjectId}/snippets/codename/xCodename`);
        expect(idUrl).toEqual(`https://manage.kenticocloud.com/v2/projects/${testProjectId}/snippets/xInternalId`);
        expect(externalIdUrl).toEqual(`https://manage.kenticocloud.com/v2/projects/${testProjectId}/snippets/external-id/xExternal`);
    });
