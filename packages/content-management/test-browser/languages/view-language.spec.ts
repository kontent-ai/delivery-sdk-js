...
describe('View language', () => {
    ...
    it(`url should be correct`, () => {
        ...
        expect(idUrl).toEqual(`https://manage.kenticocloud.com/v2/projects/${testProjectId}/languages/xId`);
        expect(codenameUrl).toEqual(
            `https://manage.kenticocloud.com/v2/projects/${testProjectId}/languages/codename/xCodename`
        );
        expect(externalIdUrl).toEqual(
            `https://manage.kenticocloud.com/v2/projects/${testProjectId}/languages/external-id/xExternalId`
        );
    });
